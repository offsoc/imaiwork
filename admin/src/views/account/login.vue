	...
	<div class="login flex flex-col">
		<div class="flex-1 flex items-center justify-center">
			<div class="login-card flex rounded-md">
				<div
					class="flex-1 h-full hidden md:inline-block bg-primary-light-9">
					<img
						class="h-full object-contain max-w-[400px]"
		...
		<div
			class="text-center fixed bottom-[5vh] w-full text-base text-[#999]"
			v-if="config.tips && config.tips != 'ok'">
