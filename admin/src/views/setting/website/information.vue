    ...
    <div class="website-information">
        <el-form ref="formRef" :rules="rules" class="ls-form" :model="formData" label-width="120px">
            ...
            <el-card shadow="never" class="!border-none mt-4">
                ...
                <el-form-item label="前台标题" prop="shop_title">
                    <div class="w-80">
                        <el-input
                            v-model.trim="formData.shop_title"
                            placeholder="请输入前台标题"
                            maxlength="30"
                            show-word-limit />
                    </div>
            ...
            <el-card shadow="never" class="!border-none mt-4">
                ...
                <el-form-item label="网站icon" prop="pc_ico">
                    <div>
                ...
                <!-- <el-form-item label="登录页广告图" prop="login_image">
                    <div>
                        ...
                        <div class="form-tips">建议尺寸：360*645像素，支持jpg，jpeg，png格式</div>
                    </div>
                </el-form-item> -->
            ...
            <el-card shadow="never" class="!border-none mt-4">
                <div class="text-xl font-medium mb-[20px]">小程序设置</div>
                <el-form-item label="分享logo" prop="share_image">
                    <div>
