		...
		<popup
			...
			<el-form
				...
				<el-form-item
					...
					<material-picker
						:limit="1"
						v-model="formData.logo"></material-picker>
				</el-form-item>

				<el-form-item label="分类父级" prop="pid">
					<el-select
						class="ls-input"
...
import {
	...
	assistantCategoryAdd,
	assistantCategoryEdit,
...
const handleSubmit = async () => {
	...
	mode.value == "edit"
		? await assistantCategoryEdit(formData)
		: await assistantCategoryAdd(formData);
