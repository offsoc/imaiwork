<template>
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table
                ...
                <el-table-column prop="job_name" label="文件大小" min-width="80" show-overflow-tooltip>
    ...
    <el-drawer v-model="drawerVisible" title="切片详情" size="50%">
        <div class="h-full flex flex-col">
            <div class="mb-4">
                <el-input v-model="chunkParams.name" placeholder="请输入文件名" clearable class="w-[380px]">
                    <template #append>
...
import {
    getKnowledgeTrainingFiles,
    deleteKnowledgeTrainingFile,
    knowKnowledgeChunkDetail,
