                    ...
                    <div>
                        <div class="flex flex-wrap gap-2">
                            ...
                            <div v-for="(item, index) in form.images" :key="index" class="material-item">
                                ...
                                <div
                                    class="absolute -top-2 -right-2 cursor-pointer rounded-full bg-danger p-1 leading-[0]"
                                    @click="handleDeleteImage(index)">
                                    <Icon name="el-icon-Delete" color="#ffffff" :size="12" />
                                </div>
                            </div>
                            <!-- 上传按钮 -->
                            <upload
                                ...
                                <div class="material-item">
                                    <Icon name="el-icon-Plus" :size="18" color="#0000004d" />
                                    <span class="text-[#0000004d] text-xs">上传图片</span>
                                </div>
                            </upload>
                        </div>
