<template>
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div class="mb-4">
                <el-button v-perms="['draw_goods.case/add']" type="primary" @click="handleAdd">新增</el-button>
            </div>
            <el-table :data="pager.lists" style="width: 100%" v-loading="pager.loading">
                <el-table-column prop="id" label="ID" width="80" />
                <el-table-column prop="params.text" label="描述" min-width="200" show-overflow-tooltip />
