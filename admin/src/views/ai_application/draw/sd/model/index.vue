	...
	<div>
		...
		<el-card class="!border-none mt-4" shadow="never">
			<div class="flex gap-2">
				<router-link
					v-perms="['ai_application.sd.model/add']"
					:to="getRoutePath('ai_application.sd.model/add:edit')">
			...
			<el-table
				...
				<el-table-column
					label="状态"
					min-width="100"
					v-perms="['ai_application.sd.model/status']">
					<template #default="{ row }">
						<el-switch
				...
				<el-table-column label="操作" width="150" fixed="right">
					<template #default="{ row }">
						<el-button type="primary" link>
							<router-link
								v-perms="['ai_application.sd.model/edit']"
								:to="{
									path: getRoutePath(
										'ai_application.sd.model/add:edit'
									),
									query: {
										id: row.id,
									},
						...
						<el-button
							v-perms="['ai_application.sd.model/del']"
							type="danger"
							link
