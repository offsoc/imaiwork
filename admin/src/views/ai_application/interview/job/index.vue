	...
	<div>
		...
		<el-card class="!border-none mt-4" shadow="never">
			<div class="mb-4 flex gap-4">
				<el-button
					v-perms="['ai_application.interview.job/del']"
					type="default"
					:plain="true"
			...
			<el-table
				...
				<el-table-column
					label="状态"
					width="100"
					v-perms="['ai_application.interview.job/status']">
					<template #default="{ row }">
						<el-switch
							v-model="row.status"
							:active-value="1"
				...
				<el-table-column label="操作" width="120" fixed="right">
					<template #default="{ row }">
						<el-button
							v-perms="['ai_application.interview.job/detail']"
							type="primary"
							link>
							<router-link
								:to="{
									path: getRoutePath(
										'ai_application.interview.job/detail'
									),
									query: {
										id: row.id,
									},
...
import {
	...
	interviewJobDelete,
	interviewJobStatus,
} from "@/api/ai_application/interview/job";
