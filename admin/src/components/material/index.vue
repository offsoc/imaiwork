<template>
	<div class="material" v-loading="pager.loading">
					...
					<div class="material-left__content pt-4 p-b-4">
						<el-tree
							...
							<template v-slot="{ data }">
								<div
									class="flex flex-1 items-center min-w-0 pr-4">
									<img
		...
		<div class="material__center flex flex-col">
			<div class="operate-btn flex">
				<div class="flex-1 flex">
					...
					<popup
						...
						title="移动文件">
						<template #trigger>
							<el-button :disabled="!select.length"
								>移动</el-button
							>
						</template>
			...
			<div
				class="material-center__content flex flex-col flex-1 mb-1 min-h-0">
				<el-scrollbar
					v-if="pager.lists.length && listShowType == 'normal'">
		...
		<div class="material__right" v-if="mode == 'picker'">
			<div class="flex justify-between p-2 flex-wrap">
				...
				<el-button type="primary" link @click="clearSelect"
					>清空</el-button
				>
			</div>
			<div class="flex-1 min-h-0">
