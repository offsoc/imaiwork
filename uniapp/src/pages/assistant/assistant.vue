    ...
    <view class="h-screen flex flex-col relative bg-[#F5F6F6]">
        ...
        <view class="grow min-h-0 relative z-10">
            <view class="h-full flex">
                <view class="w-[248rpx] h-full flex flex-col overflow-hidden flex-shrink-0 rounded-tr-[36rpx] bg-white">
                        ...
                        <scroll-view scroll-y class="h-full">
                            <view
                                ...
                                :class="[
                                    ...
                                    {
                                        'robot-cate-brother':
                                            robotSubCateIndex == item.sub_list.length - 1 && isCurrMenu(item.sub_list),
                                    },
                                    {
                                ...
                                <view class="robot-cate-item">
                                    <view class="robot-cate-item-wrap">
                                        <view class="flex items-center gap-2 w-full">
                                            <view class="flex-1 text-[#6D6E70] text-xs font-bold">{{ item.name }}</view>
                                            <u-icon
