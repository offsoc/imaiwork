<template>
	<view class="h-screen bg-[#F9FAFD] flex flex-col">
		...
		<view class="relative">
			<image
				src="@/ai_modules/ladder_player/static/images/home/cover.png"
				class="w-full h-[588rpx]"></image>
					...
					<view class="card-box">
						<view
							...
							<view>
								...
								<view
									class="text-sm text-[#ACABB9] mt-2 leading-[40rpx]">
									{{ item.description }}
								</view>
							</view>
						</view>
		...
		<view
			class="fixed bottom-4 left-0 w-full z-40"
			v-if="queryParams.common == 2">
			<view>
				<u-button
					type="primary"
					shape="circle"
