			...
			<view class="flex items-center justify-between">
				<view class="relative">
					<text class="text-xl font-bold"
						>我的模特（{{ dataLists.length }}）</text
					>
					<view
						class="absolute bottom-[-6rpx] left-[20%] w-[48rpx] h-[6rpx] bg-primary rounded-full"></view>
				</view>
			...
			<z-paging
				...
				<view class="grid grid-cols-2 gap-2 px-4">
					<view
						...
						:key="index">
						<view
							class="absolute top-2 right-2 z-[8888]"
							v-if="isDelete">
							<view
								class="radio-wrap"
								:class="{
									'radio-wrap-active': active.includes(
										item.id
									),
								}"
