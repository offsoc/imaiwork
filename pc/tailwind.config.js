...
module.exports = {
    ...
    theme: {
        colors: {
            ...
            "app-bg-1": "var(--app-bg-color-1)",
            "app-bg-2": "var(--app-bg-color-2)",
            "app-bg-3": "var(--app-bg-color-3)",
            "app-bg-4": "var(--app-bg-color-4)",
            "app-border-1": "var(--app-border-color-1)",
            "app-border-2": "var(--app-border-color-2)",
        },
        fontFamily: {
