			...
			<div>
				...
				<div class="mt-2">
					<div v-if="activeName === TypeLists.TEXT" class="relative">
						...
						<div
							class="absolute bottom-2 w-full px-2 flex items-center justify-between">
							<ElPopover
								placement="bottom"
								width="466"
								trigger="click"
					...
					<div
						v-if="
							[TypeLists.IMAGE, TypeLists.VIDEO].includes(
								activeName
							)
						"
						class="w-full">
						<upload
							...
							<div
								...
								<div
									v-else
									class="h-full w-full flex justify-center relative"
									...
									<div
										...
										@click.stop="
											previewVideo(fileData.video.uri)
										">
										<Icon
				...
				<div class="mt-8">
					<div class="flex justify-center">
						<img
							src="../_assets/images/arrow_down.png"
							class="w-[25px]" />
					</div>
				</div>
			</div>
					...
					<div class="px-4" v-draggable="draggableOptions">
						<div class="material-list mt-4 flex flex-col gap-y-4">
							<div
								...
								<div
									class="text-white flex items-center gap-x-4 flex-1 w-0">
								...
								<div
									...
									<div
										class="move-icon cursor-move leading-[0]">
										<Icon
											name="el-icon-Rank"
											color="#ffffff"
											:size="20" />
					...
					<div class="py-14 px-5 flex flex-col gap-y-2">
						<div
							...
							<div
								...
								v-if="item.type === TypeLists.IMAGE">
								<ElImage
									:src="item.content"
							...
							<div
								...
								v-if="item.type === TypeLists.VIDEO">
								<ElImage
								...
								<div
									...
									@click="
										previewVideo(item.content.video.uri)
									">
									<Icon
										name="local-icon-play"
										:size="50"
...
onHandleEvent("action", (data: any) => {
	...
	switch (type) {
		case EnumHandleEvent.ChooseEmoji:
			fileData.text = setRangeText(
				textInputRef.value?.textarea!,
				data.emoji
			);
	}
});
...
const handleAddInfo = () => {
	...
	materialLists.value = [
		...materialLists.value,
		{
			...
			content:
				activeName.value == TypeLists.TEXT
					? fileData.text
					: fileData.image.uri,
		},
	];
