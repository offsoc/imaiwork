<template>
	<div class="h-full flex flex-col bg-white rounded-lg overflow-hidden">
		<div
			class="h-[48px] bg-primary text-white text-2xl flex items-center px-4">
			策略设置
		</div>
					...
					<div class="flex flex-col">
						...
						<div class="mt-2">
							<ElRadioGroup v-model="formData.multiple_type">
								...
								<ElRadio :value="1">合并回复</ElRadio>
								<ElRadio :value="2">只回复最后一条</ElRadio>
							</ElRadioGroup>
						</div>
					</div>
				</div>
