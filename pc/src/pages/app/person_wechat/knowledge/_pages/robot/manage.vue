	...
	<div class="h-full flex flex-col">
		<div class="flex items-center justify-between bg-white p-4 rounded-lg">
			...
			<div class="flex items-center gap-2">
				<ElButton type="primary" @click="handleAdjust"
					>AI角色调整</ElButton
				>
			</div>
		</div>
		<div class="grow min-h-0 flex flex-col bg-white rounded-lg pt-4 mt-4">
			<div class="px-4">
				<ElTabs v-model="tabName">
					<ElTabPane label="问答话术" name="1" v-if="false">
						<div class="grow min-h-0"></div>
					</ElTabPane>
					<ElTabPane label="关键词回复 " name="2">
						<div class="grow min-h-0"></div>
					</ElTabPane>
				</ElTabs>
			</div>
			<div class="grow min-h-0">
				<QaPage v-if="tabName === '1'" />
...
import QaPage from "../qa/index.vue";
import KeywordsPage from "../keywords/index.vue";
