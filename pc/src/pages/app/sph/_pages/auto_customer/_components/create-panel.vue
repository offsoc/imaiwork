<template>
	<div class="h-full bg-app-bg-2 rounded-[20px] flex flex-col">
		<!-- 头部导航 -->
		<div
			class="flex-shrink-0 flex items-center justify-between px-[14px] h-[88px] border-b border-[#ffffff1a]">
			<div
					...
					<div class="mt-6 flex flex-col gap-y-3">
						...
						<div>
							...
							<div class="keyword-content">
								<div
									class="max-h-[200px] overflow-y-auto flex flex-col gap-y-2 dynamic-scroller">
									<div
										v-for="(
											item, index
										) in formData.keywords"
										:key="index"
										...
										<div
											class="w-[1px] h-[12px] bg-[#ffffff1a]"></div>
										<div>
											<div
												class="w-4 h-4"
												@click="
													handleKeywordDelete(index)
												">
												<close-btn
...
const handleGreetingContentSetting = async (
	type: GreetingContentSettingTypeEnum
) => {
