                                ...
                                <ElScrollbar>
                                    <div class="grid grid-cols-3 gap-2">
                                        <upload
                                            ...
                                            <div
                                                class="h-[127px] w-full flex-col rounded-md flex items-center justify-center bg-draw-bg">
                                                <Icon name="local-icon-draw_upload" :size="28" color="#ffffff"></Icon>
                                        ...
                                        <div
                                            ...
                                            :key="index"
                                            class="relative h-[130px] w-full flex-col rounded-md flex items-center justify-center bg-draw-bg overflow-hidden border-[2px] border-[#ffffff33] cursor-pointer group"
...
import { FashionImageTypeEnum } from "../_enums/drawEnums";
