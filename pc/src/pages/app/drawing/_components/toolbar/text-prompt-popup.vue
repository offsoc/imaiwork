<template>
    <popup ref="promptPopRef" width="450" cancel-button-text="" confirm-button-text="">
        <div class="p-">
            <div class="font-bold -mt-5">AI提示词</div>
            <div class="">
                <div class="text-[#B4B4B4] mt-4">写一段简单的描述，自动为你补充生成完善的描述信息</div>
                <div class="mt-2">
                    <ElInput
                        v-model="promptValue"
                        type="textarea"
                    ...
                    <div class="!text-xs max-h-[500px]">
                        <div class="flex flex-col gap-4 content-box">
                            <div
                                ...
                                :key="index"
                                class="border border-token-primary-3 rounded-lg p-4">
                                <div>
                                    {{ content }}
                                </div>
