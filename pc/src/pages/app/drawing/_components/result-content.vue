<template>
	...
	<div class="flex flex-col gap-5 min-w-[700px]">
		<div v-for="item in resultLists">
			...
			<div
				...
				:class="`grid-cols-${
					item.images?.length || item.video?.length || 4
				}`">
				<template v-if="type == 'image'">
					<div
						...
						<div
							v-else-if="[3, 4].includes(image.status)"
							class="w-full pb-[80%]">
							<div
				...
				<template v-if="type == 'video'">
					<div
						...
						<div
							v-else-if="video.status == 50430"
							class="absolute bottom-4 left-4 z-[888]">
			...
			<div class="mt-4 flex h-[20px]">
				<ElTooltip
					...
					<div
						...
						@click="emit('retry', item.formData)">
						<Icon
	...
	<preview-video
		...
		ref="previewVideoRef"
		@close="showPreviewVideo = false"></preview-video>
</template>
