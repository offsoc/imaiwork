...
use Jubo\JuLiao\IM\Wx\Proto\{EnumMsgType, FriendChangeNoticeMessage, FriendMessage};
 ...
 */
class FriendChangeNoticeHandler extends BaseHandler
{
    ...
    {
        $request = new FriendChangeNoticeMessage();
        ...
        // 返回响应体
        return $this->buildJsonResponse(EnumMsgType::FriendChangeNotice, $content);
    }

    /**
     * 构建响应内容
     * 
     * @param FriendChangeNoticeMessage $request 好友变更通知消息
     * @param string $deviceId 设备ID
     * @return array
     */
    private function buildResponseContent(FriendChangeNoticeMessage $request, string $deviceId): array
    {
        /**
        ...
        $this->logInfo('Friend change notice', $content);
