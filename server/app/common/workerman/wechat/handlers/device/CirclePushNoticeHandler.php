 ...
 */
class CirclePushNoticeHandler extends BaseHandler
{
    /**
     * 处理朋友圈推送通知
     * 
    ...
    protected function handle(string $data, array $context): array
    {
        ...
        // 返回响应体
        return $this->buildJsonResponse(EnumMsgType::CirclePushNotice, $content);
    }

    /**
     * 构建响应内容
     * 
     * @param CirclePushNoticeMessage $request 朋友圈推送通知消息
