 ...
 * @author Qasim
 */
class RobotLogic extends WechatBaseLogic
{
    ...
    public static function addRobot(array $params)
    {
        ...
        try {
            ...
            // 添加
            $robot = AiWechatRobot::create($params);
    ...
    public static function updateRobot(array $params)
    {
        ...
        try {
            // 检查机器人是否存在
            $robot = AiWechatRobot::where('id', $params['id'])->where('user_id', self::$uid)->findOrEmpty();
            if ($robot->isEmpty()) {
            ...
            // 更新
            AiWechatRobot::where('id', $robot->id)->update($params);
