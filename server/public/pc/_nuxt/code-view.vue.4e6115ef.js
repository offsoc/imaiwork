import{_ as x}from"./index.vue.f38ca415.js";import{_ as b}from"./index.vue.70e33322.js";import{d as g,A as j,aF as k,c as o,bI as y,k as C,I as $,s as B,m as t,q as n,Z as l,cO as D}from"./entry.d7219633.js";const I=g({__name:"code-view",emits:["close"],setup(F,{expose:m,emit:p}){const d=p,s=j(),a=k({apikey:""}),i=o(()=>`${location.origin}/chat/${a.apikey}`),f=o(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
