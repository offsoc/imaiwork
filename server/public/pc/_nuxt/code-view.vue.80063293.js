import{_ as x}from"./index.vue.3e248b2d.js";import{_ as b}from"./index.vue.287e2e78.js";import{d as g,A as j,aF as k,c as o,bI as y,k as C,I as $,s as B,m as t,q as n,Z as l,cP as D}from"./entry.d9d53b29.js";const I=g({__name:"code-view",emits:["close"],setup(F,{expose:m,emit:p}){const d=p,s=j(),a=k({apikey:""}),i=o(()=>`${location.origin}/chat/${a.apikey}`),f=o(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
