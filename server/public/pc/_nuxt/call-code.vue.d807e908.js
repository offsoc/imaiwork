import{_ as d}from"./index.vue.478e85a5.js";import{_ as $}from"./index.vue.0a368a30.js";import{d as f,A as T,aF as C,c as R,bK as O,k as P,I as k,s as x,m as e,q as s,cV as y}from"./entry.2beb4577.js";const S=f({__name:"call-code",props:{showChatType:{type:[Boolean,Number]}},emits:["close"],setup(E,{expose:n,emit:r}){const p=r,o=T(),t=C({apikey:""});R(()=>`${location.origin}/chat/${t.apikey}`);const l=`
【接口地址】
请求方式: POST
