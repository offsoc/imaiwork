import{_ as x}from"./index.vue.478e85a5.js";import{_ as b}from"./index.vue.0a368a30.js";import{d as g,A as j,aF as k,c as o,bK as y,k as C,I as $,s as B,m as t,q as n,Z as l,cV as D}from"./entry.2beb4577.js";const V=g({__name:"code-view",emits:["close"],setup(F,{expose:m,emit:p}){const d=p,s=j(),a=k({apikey:""}),i=o(()=>`${location.origin}/chat/${a.apikey}`),f=o(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
