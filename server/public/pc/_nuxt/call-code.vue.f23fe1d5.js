import{_ as d}from"./index.vue.f38ca415.js";import{_ as $}from"./index.vue.70e33322.js";import{d as f,A as T,aF as C,c as R,bI as O,k as P,I as k,s as x,m as e,q as s,cO as y}from"./entry.d7219633.js";const S=f({__name:"call-code",props:{showChatType:{type:[Boolean,Number]}},emits:["close"],setup(E,{expose:n,emit:r}){const p=r,o=T(),t=C({apikey:""});R(()=>`${location.origin}/chat/${t.apikey}`);const l=`
【接口地址】
请求方式: POST
